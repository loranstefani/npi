...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'enumerations_enumeration', (
            ...
            ('name_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=150, db_index=True, blank=True)),
            ('middle_name', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=150, db_index=True, blank=True)),
            ('name_suffix', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True)),
            ...
            ('other_name_prefix_1', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True)),
            ('other_name_suffix_1', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True)),
            ...
            ('other_name_prefix_2', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True)),
            ('other_name_suffix_2', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True)),
            ...
            ('modify_token', self.gf('django.db.models.fields.CharField')(default='d99579c0-e3dd-48ba-bd16-ea858bbcd064', max_length=36, blank=True)),
            ...
            ('contact_person_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True)),
            ('contact_person_suffix', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True)),
            ...
            ('authorized_official_prefix', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True)),
            ...
            ('authorized_official_suffix', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True)),
        ...
        # Adding M2M table for field direct_certificates on 'Enumeration'
        m2m_table_name = db.shorten_name(u'enumerations_enumeration_direct_certificates')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('enumeration', models.ForeignKey(orm[u'enumerations.enumeration'], null=False)),
            ('directcertificate', models.ForeignKey(orm[u'direct.directcertificate'], null=False))
        ))
        db.create_unique(m2m_table_name, ['enumeration_id', 'directcertificate_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field direct_certificates on 'Enumeration'
        db.delete_table(db.shorten_name(u'enumerations_enumeration_direct_certificates'))
    ...
    models = {
        ...
        u'direct.directcertificate': {
            'Meta': {'object_name': 'DirectCertificate'},
            'added': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'dns': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3000', 'db_index': 'True', 'blank': 'True'}),
            'file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '255L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'enumerations.enumeration': {
            ...
            'authorized_official_prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'blank': 'True'}),
            'authorized_official_suffix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            ...
            'contact_person_prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5', 'blank': 'True'}),
            'contact_person_suffix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            ...
            'direct_certificates': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'enumerations_direct_certificates'", 'to': u"orm['direct.DirectCertificate']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True', 'db_index': 'True'}),
            ...
            'first_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'db_index': 'True', 'blank': 'True'}),
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'db_index': 'True', 'blank': 'True'}),
            ...
            'middle_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150', 'blank': 'True'}),
            'modify_token': ('django.db.models.fields.CharField', [], {'default': "'8f1a3680-5a31-4d65-977c-46848181e39e'", 'max_length': '36', 'blank': 'True'}),
            'name_prefix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5', 'blank': 'True'}),
            'name_suffix': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            ...
            'other_name_prefix_1': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5', 'blank': 'True'}),
            'other_name_prefix_2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '5', 'blank': 'True'}),
            'other_name_suffix_1': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
            'other_name_suffix_2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '4', 'blank': 'True'}),
